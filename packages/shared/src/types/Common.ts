...
export interface EncryptFunction {
  (plainText: string, publicKey: string, encryption?: Encryption): Promise<
    string | boolean
  >
}
...
export type AuthorizeResourceResponse = {
  authorizeResource: { code?: Maybe<number>; message?: Maybe<string> }
}
...
export type CreatePolicyResponse = {
  createPolicy: {
    ...
    statements: Array<{
      ...
      effect?: Maybe<PolicyEffect>
      condition?: Maybe<
        Array<{ param: string; operator: string; value: unknown }>
      >
    }>
  }
}
...
export type CreateUserWithCustomDataResponse = {
  createUser: {
    id: string
    arn: string
    userPoolId: string
...
export type MoveMembersResponse = {
  moveMembers?: Maybe<{ code?: Maybe<number>; message?: Maybe<string> }>
}
...
export type ResetPasswordByFirstLoginTokenResponse = {
...
export type ResetPasswordByForceResetTokenResponse = {
...
export type SendFirstLoginVerifyEmailResponse = {
  sendFirstLoginVerifyEmail: { message?: Maybe<string>; code?: Maybe<number> }
}
...
export type SetMainDepartmentResponse = {
  setMainDepartment: { message?: Maybe<string>; code?: Maybe<number> }
}
...
export type SetUdfValueBatchResponse = {
  setUdfValueBatch?: Maybe<{ code?: Maybe<number>; message?: Maybe<string> }>
}
...
export type AuthorizedTargetsResponse = {
...
export type GroupWithUsersWithCustomDataResponse = {
  group?: Maybe<{
    users: {
      totalCount: number
      list: Array<{
...
export type AuthorizedResourcesResponse = {
...
export type ListGroupAuthorizedResourcesResponse = {
  group?: Maybe<{
    authorizedResources?: Maybe<{
      totalCount: number
      list: Array<{
...
export type ListNodeByCodeAuthorizedResourcesResponse = {
  nodeByCode?: Maybe<{
    authorizedResources?: Maybe<{
      totalCount: number
      list: Array<{
...
export type ListNodeByIdAuthorizedResourcesResponse = {
  nodeById?: Maybe<{
    authorizedResources?: Maybe<{
      totalCount: number
      list: Array<{
...
export type ListRoleAuthorizedResourcesResponse = {
  role?: Maybe<{
    authorizedResources?: Maybe<{
      totalCount: number
      list: Array<{
...
export type ListUserAuthorizedResourcesResponse = {
  user?: Maybe<{
    authorizedResources?: Maybe<{
      totalCount: number
      list: Array<{
...
export type SearchUserWithCustomDataResponse = {
  searchUser: {
    totalCount: number
    list: Array<{
      id: string
...
export type UdfValueBatchResponse = {
  udfValueBatch: Array<{
    targetId: string
    data: Array<{
      key: string
...
export type UsersWithCustomDataResponse = {
  users: {
    totalCount: number
    list: Array<{
      id: string
