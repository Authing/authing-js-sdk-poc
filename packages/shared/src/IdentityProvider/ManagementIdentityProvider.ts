import { User, ManagementSDKConfig } from '../types'
...
export interface ManagementIdentityProvider {
  config: ManagementSDKConfig
  token: string
  user: User
...
export function createManagementIdentityProvider(config: ManagementSDKConfig): ManagementIdentityProvider {
  return {
    config,
    token: '',
    user: initUser(),
